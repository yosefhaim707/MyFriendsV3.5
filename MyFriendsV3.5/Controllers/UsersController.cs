...
using MyFriendsV3._5.Services;
using MyFriendsV3._5.ViewModels;
...
namespace MyFriendsV3._5.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(MyFriendsV3_5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create(UserCreateViewModel userCreateViewModel)
        {
            ...
            if (ModelState.IsValid && FileService.IsValidImageFile(userCreateViewModel.ProfileImage))
            {
                _context.Add(userCreateViewModel.User);
